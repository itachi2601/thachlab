...
export const CNC_ASSESSMENT_PLAN: Record<string, readonly string[]> = {
  "lesson-1": ["final"],
  "lesson-2": ["exercise-1", "exercise-2", "exercise-6", "exercise-3", "exercise-4", "exercise-5"],
  "lesson-3": ["exercise-1", "exercise-2", "exercise-6", "exercise-3", "exercise-4", "exercise-5"],
  ...
  "lesson-6": ["checklist-practice", "checklist", "rubric-exam"],
};
